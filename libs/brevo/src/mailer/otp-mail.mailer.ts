      ...
      <body>
        <div class="email-container">
          ...
          <div class="email-body">
            ...
            <p>Thank you for choosing Chowberry.</p>
          </div>
          <div class="email-footer">
            <p>Chowberry technologies, House 70, road 22, Kado Estate, Abuja</p>
            <p>&copy; 2024 Chowberry technologies. All rights reserved.</p>
          </div>
        </div>
      </body>
    </html>
