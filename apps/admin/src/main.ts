...
import { ADMIN_CONSTANTS } from '@app/constants/admin.constants';
...
async function bootstrap() {
    ...
    app.connectMicroservice(
        rmq.getOptions(ADMIN_CONSTANTS.RABBIT_URI, ADMIN_CONSTANTS.RABBIT_QUEUE_TITLE),
    );
    await app.startAllMicroservices();
    await app.listen(ADMIN_CONSTANTS.PORT);
}
void bootstrap();
